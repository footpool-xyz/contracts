...
install :; forge install openzeppelin/openzeppelin-contracts-upgradeable@v5.0.2 --no-commit && forge install openzeppelin/openzeppelin-contracts@v5.0.2 --no-commit && forge install foundry-rs/forge-std@v1.8.2 --no-commit && forge install smartcontractkit/chainlink --no-commit
