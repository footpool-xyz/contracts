...
install :; forge install openzeppelin/openzeppelin-contracts-upgradable@5.0.2 --no-commit && forge install openzeppelin/openzeppelin-contracts@5.0.2 --no-commit && forge install foundry-rs/forge-std@v1.8.2 --no-commit
